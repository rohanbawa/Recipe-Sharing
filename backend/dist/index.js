...
app.post('/api/register', (req, res) => {
  ...
  app.post('/api/recipes/create', (req, res) => {
    ...
    connection.query(query, [title, description, ingredients, instructions], (err, results) => {
      if (err) {
  ...
  app.put('/api/recipes/:id/update', (req, res) => {
    ...
    connection.query(query, [title, description, ingredients, instructions, id], (err, results) => {
      if (err) {
  ...
  app.post('/api/recipes/:id/comments/create', (req, res) => {
    ...
    const query = 'INSERT INTO comments (recipe_id, author, content) VALUES (?,?,?)';
